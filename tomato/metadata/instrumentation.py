...
class Instrumentation(object):
    ...
    def _identify_instrumentation(cls, instrument_vocal_list):
        if cls._solo_instrumental(instrument_vocal_list):
            return "solo instrumental"
        elif cls._duo_instrumental(instrument_vocal_list):
            return "duo instrumental"
        elif cls._trio_instrumental(instrument_vocal_list):
            return "trio instrumental"
        elif cls._ensemble(instrument_vocal_list):
            return "ensemble instrumental"
        elif cls._solo_vocal_wo_acc(instrument_vocal_list):
            return "solo vocal without accompaniment"
        elif cls._solo_vocal_w_acc(instrument_vocal_list):
            return "solo vocal with accompaniment"
        elif cls._duet(instrument_vocal_list):
            return "duet"
        elif cls._choir(instrument_vocal_list):
            return "choir"
        else:
    ...
    @staticmethod
    def _solo_vocal_wo_acc(instrument_vocal_list):
    ...
    @staticmethod
    def _solo_vocal_w_acc(instrument_vocal_list):
        return (len(instrument_vocal_list) > 1 and
    ...
    @staticmethod
    def _duet(instrument_vocal_list):
    ...
    @staticmethod
    def _choir(instrument_vocal_list):
    ...
    @staticmethod
    def _solo_instrumental(instrument_vocal_list):
        return (len(instrument_vocal_list) == 1 and
    ...
    @staticmethod
    def _duo_instrumental(instrument_vocal_list):
    ...
    @staticmethod
    def _trio_instrumental(instrument_vocal_list):
    ...
    @staticmethod
    def _ensemble(instrument_vocal_list):
